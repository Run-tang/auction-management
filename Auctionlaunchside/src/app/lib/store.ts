...
export const STATUS_CONFIG: Record<VehicleStatus, { text: string; cls: string; bgCls: string }> = {
  ...
  ready: { text: '待发拍', cls: 'bg-[#DBEAFE] text-[#2563EB]', bgCls: 'bg-[#DBEAFE]' },
...
let applications: Application[] = [
  {
    ...
    carBrand: '宝马', carSeries: '5系', carModel: '2022款 530Li 领先型', carYear: 2022,
  ...
  },
  {
    ...
    carBrand: '特斯拉', carSeries: 'Model 3', carModel: '2023款 长续航全轮驱动版', carYear: 2023,
  ...
  },
  {
    ...
    carBrand: '奔驰', carSeries: 'E级', carModel: '2023款 E300L 豪华型', carYear: 2023,
    engineCapacity: '2.0T', transmission: '自动', fuelType: '汽油',
  ...
  },
  {
    ...
    carBrand: '丰田', carSeries: '凯美瑞', carModel: '2024款 2.5L 混动豪华版', carYear: 2024,
  ...
  },
  {
    ...
    carBrand: '宝马', carSeries: '3系', carModel: '2022款 325Li M运动套装', carYear: 2022,
    engineCapacity: '2.0T', transmission: '自动', fuelType: '汽油',
  ...
  },
  {
    ...
    carBrand: '奥迪', carSeries: 'Q5L', carModel: '2023款 45TFSI 豪华型', carYear: 2023,
    engineCapacity: '2.0T', transmission: '自动', fuelType: '汽油',
  ...
  },
  {
    ...
    carBrand: '宝马', carSeries: 'X3', carModel: '2023款 xDrive30i 领先型', carYear: 2023,
    engineCapacity: '2.0T', transmission: '自动', fuelType: '汽油',
    exteriorColor: '白色', interiorColor: '黑色',
...
let adminAccounts: AdminAccount[] = [
  ...
  },
  {
    ...
    lastLoginTime: '2026-03-31 08:30'
  },
];
